  ...
  return (
    <>
      <EntityCRUD
        ...
        hideFields={["employmentContracts", "employmentContract", "vehicles", "storeProfile"]} // Esconde na tabela
        hiddenFields={["employmentContracts", "employmentContract", "vehicles", "clientContracts", "bankAccount"]} // Esconde no formulário (storeProfile aparece como sub-form nested-one)
        pageTitle="Clientes"
